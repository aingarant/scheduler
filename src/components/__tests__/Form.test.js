...
describe("Form", () => {
  ...
  const { getByTestId, getByPlaceholderText, getByText, onSave, queryByText, fireEvent } = render(
    <Form interviewers={interviewers} student="" />
  );
  
  
  // it("renders without student name if not provided", () => {
  //   expect(getByPlaceholderText("Enter Student Name")).toHaveValue("Sylvia Palmer");
  // });
